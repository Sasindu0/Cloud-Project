...
<body data-bs-target=".navbar">
  ...
  <form action="/shop/add_sp" method="post">
    <section id="spare_sec" class="bg-cover home-section">
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div id="reg-ui">
              ...
              <input type="text" id="vehicle_model" name="vehicle_model" class="form-control" placeholder="Nissan GTR">

              <label for="sp_name">Spare Part:</label><br>
              <input type="text" id="sp_name" name="sp_name" class="form-control" placeholder="Spoiler"><br>

              <div class="row">
                <div class="col-lg-6">
                  <label for="qty">Quantity:</label>
                  <input type="number" id="qty" name="qty" class="form-control" placeholder="9999">
                </div>
                <div class="col-lg-6">
                  <label for="price">Price Per Unit:</label>
                  <input type="number" id="price" min="0.00" step="0.01" name="price" class="form-control" placeholder="999.99"><br>
                </div>
              </div>
